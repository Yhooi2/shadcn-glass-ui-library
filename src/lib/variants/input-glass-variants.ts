  ...
  'w-full transition-all duration-300 outline-none backdrop-blur-sm disabled:opacity-50 disabled:cursor-not-allowed',
  {
    variants: {
      size: {
        ...
        // Border radius: 8px per UI_DIZINE.md (rounded-md)
        // Touch targets: 44-48px minimum (Apple HIG)
        sm: 'px-3 py-2 text-base rounded-md min-h-[44px]',     // UI_DIZINE: 8px radius, 44px mobile
        md: 'px-4 py-2.5 text-base rounded-md min-h-[44px]',   // UI_DIZINE: 8px radius
        lg: 'px-5 py-3 text-base md:text-lg rounded-md min-h-[48px]',  // UI_DIZINE: 8px radius
      },
    },
    defaultVariants: {
      size: 'md',
