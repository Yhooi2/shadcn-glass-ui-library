...
Этот каталог содержит тесты для проверки соответствия компонентов правилам дизайн-системы из [UI_DESIGN.md](../../../docs/design-system/UI_DESIGN.md).
...
- [UI_DESIGN.md](../../../docs/design-system/UI_DESIGN.md) - Оригинальные правила
