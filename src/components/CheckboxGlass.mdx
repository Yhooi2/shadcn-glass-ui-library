...
import * as CheckboxGlassStories from './CheckboxGlass.stories';
...
- ✅ **Smooth Animation** - Check mark animation on toggle
- 📱 **Touch Optimized** - 44×44px touch target wrapper
- ♿ **WCAG 2.1 AA** - Full keyboard navigation and screen reader support
- 🎨 **Theme Support** - Glass, light, aurora themes
- 🔄 **Indeterminate State** - Support for tri-state checkbox
...
| **Touch Target** | 44×44px | Apple HIG minimum |
