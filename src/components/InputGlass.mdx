...
import * as InputGlassStories from './InputGlass.stories';
...
- ✨ **Multiple States** - default, error, success, disabled
- 🎨 **Icon Support** - Left and right icon slots
- 📱 **iOS Safe** - Minimum 16px font size (prevents auto-zoom)
- ♿ **WCAG 2.1 AA** - Proper labels, ARIA attributes
