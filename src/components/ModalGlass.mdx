...
import * as ModalGlassStories from './ModalGlass.stories';
...
- ✨ **Glass Effect** - Backdrop blur with glassmorphism styling
- 🎯 **Focus Management** - Auto-focus and focus trap
- ⌨️ **Keyboard Support** - ESC to close, Tab navigation
- 🔒 **Scroll Lock** - Prevents background scrolling
- ♿ **WCAG 2.1 AA** - Full ARIA dialog pattern
- 📐 **Multiple Sizes** - sm (400px), md (600px), lg (800px)
