  ...
  return (
    <div className="glass-page min-h-screen p-8">
      ...
      <div className="relative z-10 max-w-2xl mx-auto space-y-8">
        ...
        <section>
          ...
          <div className="flex items-center gap-6">
            <div className="text-center">
              <AvatarGlassSimple name="John Doe" size="sm" status="online" />
              <p className="text-xs text-white/60 mt-2">Small</p>
            </div>
            <div className="text-center">
              <AvatarGlassSimple name="Jane Smith" size="md" status="online" />
              <p className="text-xs text-white/60 mt-2">Medium</p>
            </div>
            <div className="text-center">
              <AvatarGlassSimple name="Bob Johnson" size="lg" status="busy" />
              <p className="text-xs text-white/60 mt-2">Large</p>
            </div>
            <div className="text-center">
              <AvatarGlassSimple name="Alice Brown" size="xl" status="away" />
        ...
        {/* Status Examples */}
        <section>
          <h2 className="text-lg font-semibold text-white/80 mb-4">Status Variants</h2>
          <div className="flex items-center gap-6">
            <div className="text-center">
              <AvatarGlassSimple name="Online User" size="md" status="online" />
              <p className="text-xs text-white/60 mt-2">Online</p>
            </div>
            <div className="text-center">
              <AvatarGlassSimple name="Busy User" size="md" status="busy" />
              <p className="text-xs text-white/60 mt-2">Busy</p>
            </div>
            <div className="text-center">
              <AvatarGlassSimple name="Away User" size="md" status="away" />
              <p className="text-xs text-white/60 mt-2">Away</p>
            </div>
            <div className="text-center">
              <AvatarGlassSimple name="Offline User" size="md" status="offline" />
              ...
              <ModalGlass.Body>
                <div className="space-y-4">
                  <p className="leading-relaxed">
                    This is a modal dialog with glassmorphism styling. It features beautiful blur
                    effects, gradient backgrounds, and smooth animations.
                  </p>
                  <p className="leading-relaxed text-white/60">
                    The modal automatically locks body scroll, closes on Escape key, and handles
