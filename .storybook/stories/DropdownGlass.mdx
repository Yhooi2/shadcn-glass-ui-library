...
import * as DropdownGlassStories from '../../src/components/DropdownGlass.stories';
...
- ✨ **Glass Effect** - Backdrop blur with smooth animations
- ⌨️ **Keyboard Navigation** - Arrow keys, Enter, ESC support
- 🎯 **Auto Positioning** - Smart placement with collision detection
- ♿ **WCAG 2.1 AA** - Full ARIA menu pattern
